...
import { getRequest, postRequest, putRequest, deleteRequest, importRequest, uploadFileRequest } from '@/util/axios';
...
// 保存表单信息
export const insertOrUpdateForm = (params) => {
    return postRequest('/form/insertOrUpdate', params)
}
// 保存表单信息
export const getFormList = (params) => {
    return getRequest('/form/getByPage', params)
}
export const deleteFormById=(ids)=>{
    return deleteRequest(`/form/delByIds/${ids}`)
    }
export const getFormInfo=(id)=>{
    return getRequest(`/form/get/${id}`)
}
