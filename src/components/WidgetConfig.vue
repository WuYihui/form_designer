        ...
        <template v-if="data.options.remote">
          <div>
            <el-input size="mini" style="" v-model="data.options.remoteFunc">
             ...
             <el-input size="mini" style="" v-model="data.options.props.dataValue">
              <template slot="prepend">返回数据值</template>
            </el-input>
